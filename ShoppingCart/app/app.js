var app = angular.module('app', ['ngRoute', 'ngResource', 'rx', 'kendo.directives','ui.bootstrap']);
...
app.run(function($http, configuration) {

    //IN your promise.then:

    configuration.save('save me');
});
